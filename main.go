...
func init() {
	...
	// 默认昵称
	adana := flag.String("n", "神代枫", "Set default nickname.")
	...
	config.Z = zero.Config{
		NickName:      append([]string{*adana}, "神代", "枫", "神代枫", "巫女"),
...
func main() {
	...
	zero.OnFullMatch("#查看公告", zero.OnlyToMe, zero.AdminPermission).SetBlock(true).
		Handle(func(ctx *zero.Ctx) {
